...
keytool -import -alias server -trustcacerts -file server.crt -keypass password -storepass password -keystore client.jks
...
keytool -import -alias client -trustcacerts -file client.crt -keypass password -storepass password -keystore client.jks
